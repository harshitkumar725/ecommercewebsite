			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						<li><a href="../testingelectro/logout.php"><i class="fa fa-dollar"></i>Logout</a></li>
						<li><a href="../testingelectro/userprofile.php"><i class="fa fa-user-o"></i>'.$ua.'</a></li>
					</ul>
				</div>
			</div>
			<!-- /TOP HEADER -->
					...
					<div class="row">
						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								...
								<!-- Cart -->
								<div class="dropdown">
									<a href="../cart/viewcart.php" class="dropdown-toggle">
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="../shippingdetails\shippingdetails.php">Edit Shipping Details</a></li>
			...
			<div class="container">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								...
								<p><strong>CHANGE FULLNAME: &nbsp</strong>'.$fullname.'</p> TO 
								<input class="input" type="text" name="fullname" placeholder="FULL NAME">

								<p><strong>CHANGE EMAIL:    &nbsp &nbsp &nbsp &nbsp &nbsp</strong>'.$email.'</p> TO 
								<input class="input" type="text" name="email" placeholder="EMAIL">
								
								<p><strong>CHANGE PHONE:   &nbsp &nbsp &nbsp &nbsp</strong>'.$phone.'</p>
								<input class="input" type="number" name="phone" placeholder="PHONE NUMBER">

								<p><strong>CHANGE GENDER:   &nbsp &nbsp &nbsp</strong>'.$gender.'</p>
								<input class="input-radio" type="radio" name="gender" value="male">male
								<input class="input-radio" type="radio" name="gender" value="female">female<br><br>
				...
				<!--	<div class="col-md-5 order-details">
						...
						<div class="input-checkbox">
							...
							<label for="terms">
								<span></span>
								Ive read and accept the <a href="#">terms & conditions</a>
							</label>
						</div>
