					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<p><strong>FULLNAME: &nbsp</strong>'.$fullname.'</p>
								<p><strong>EMAIL:    &nbsp &nbsp &nbsp &nbsp &nbsp</strong>'.$email.'</p>
								<p><strong>PHONE:   &nbsp &nbsp &nbsp &nbsp</strong>'.$phone.'</p>
								<p><strong>GENDER:   &nbsp &nbsp &nbsp</strong>'.$gender.'</p>
							</div>
						...
						<div class="billing-details">
							<div class="section-title">
								<h3 class="title">Shiping Details</h3>
							</div>
							<div class="form-group">
								<p><strong>FULLNAME: &nbsp</strong>'.$fullname.'</p>
								<p><strong>EMAIL:    &nbsp &nbsp &nbsp &nbsp &nbsp</strong>'.$email.'</p>
								<p><strong>PHONE:   &nbsp &nbsp &nbsp &nbsp</strong>'.$phone.'</p>
								<p><strong>ADDRESS:   &nbsp &nbsp </strong>'.$address.'</p>
							</div>
