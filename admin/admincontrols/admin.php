<!--WRITTEN BY D RAKESH(2018IS04) FOR ADMIN WELCOME PAGE-->

<?php
session_start();
include 'C:\xampp\htdocs\php\ecommercewebsite\databse\database.php';
include 'products\productsfunctions.php';

if(isset($_SESSION['admin'])){
$ua=$_SESSION['admin'];
$pa=$_SESSION['password'];

$query="SELECT * FROM `admin` WHERE `username`='$ua' AND `password`='$pa'";
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="products\addproducts.php">Add Products</a></li>
