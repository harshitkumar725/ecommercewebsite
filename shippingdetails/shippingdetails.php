					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							<div class="section-title">
								<h3 class="title">EDIT SHIPPING DETAILS</h3>
							</div>
                            <form action="editshippingdatabase.php" method="POST">
							<div class="form-group">
							 ...
							 <br><br>	
								<p><strong>CHANGE PHONE:   &nbsp &nbsp &nbsp &nbsp</strong>'.$phone.'</p> TO
								<input class="input" type="number" name="phone" placeholder="PHONE NUMBER">
                             <br><br>
								<p><strong>CHANGE ADDRESS:    &nbsp &nbsp</strong>'.$address.'</p> TO
